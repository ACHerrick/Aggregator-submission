# Statistics and Graphs for summary across all cities
'''
Calculates and saves graphs for top 10 and bottom 10 cuisines and their ratings,
price brackets and their ratings, the number of restaurants per price bracket, the average
reviews per restaurant per price bracket, the number of restaurants per star rating, 
and the average number of reviews per star ratings.
'''
...
def cuisine_highlights(database = "yelp_adjusted.db"):
    '''
    Gets best and worst cuisines across cities, and graphs results
    '''
...
def graph_cuisine_highlights(best_frame, worst_frame):
    '''
    Creates and saves graphs for cuisine highlights as pngs

    Output:
        - "best_cuisines.png": graph of Top 10 Cuisines and Ratings
        - "worst_cuisines.png": graph of 10 Worst Cuisines and Ratingss
    '''
...
def price_ratings(database = "yelp_raw.db"):
    ...
    showing number of restaurants in each price category, graph of avg # restaurants
    per restaurant per price category
    '''
...
def star_reviews(database = "yelp_raw.db"):
    '''
    Gets avg # restaurants and avg reviews/restaurant for each star category for all cities 
    and saves sgraphs
    '''
    ...
    # Saves ratings to number of reviews per restaurant graph for "city" as 
    # "star_reviews_all_cities.png"
    ...
    # Saves price to num_restaurants graph as for "city" as "star_restaurants_city.png"
