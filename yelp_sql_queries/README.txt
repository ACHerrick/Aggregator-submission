...
This folder contains static images generated by code in this folder. These images
were used for the static display on the website of information aggregated across
all cities.
...
yelp_sql.py: Code in this file conducts all dynamic analysis of data for our 
website, including top cities for a cuisine, top cuisines for a city, number 
of restaurants and average number of reviews per restaurant for a given rating, 
rating and number of restaurants and avergae number of reviews per restaurant 
for a given price bracket, all cuisines in a city, and cuisines with the most 
number of restaurants and ratings.

yelp_all_cities.py: Code in this file calculates and saves graphs for top 10 
and bottom 10 cuisines and their ratings, price brackets and their ratings, 
the number of restaurants per price bracket, the average reviews per restaurant 
per price bracket, the number of restaurants per star rating, and the average 
number of reviews per star ratings.
