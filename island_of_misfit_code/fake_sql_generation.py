...
'''
This file contains code which loads the fake data created using fake_data_generation.py
into a mock SQL database. As with the previous file, it was used to allow initial
exploration of data and SQL queries before actual data was obtained.
